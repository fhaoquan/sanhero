...
WM_SHOW_POS = win32con.WM_USER + 514
...
class DemoWindowBase:
    ...
    def _GetDialogTemplate(self, dlgClassName):
        ...
        # Window frame and title, and size
        dlg = [ [title, (0, 0, 210, 60), style, None, (8, "MS Sans Serif"), None, dlgClassName], ]
        
        # ID label and text box
        dlg.append([130, "Mouse Pos And Sprit pos", -1, (5, 5, 200, 9), cs | win32con.SS_LEFT])
        s = cs | win32con.WS_TABSTOP | win32con.WS_BORDER
        dlg.append(['EDIT', None, IDC_SEARCHTEXT, (5, 15, 200, 12), s])
        
        dlg.append([130, "Sprit center pos offset position", -1, (5, 30, 200, 9), cs | win32con.SS_LEFT])
        s = cs | win32con.WS_TABSTOP | win32con.WS_BORDER
        dlg.append(['EDIT', None, IDC_STATUS, (5, 40, 200, 12), s])
...
##        dlg.append(['SysListView32', "Title", IDC_LISTBOX, (5, 505, 200, 200), s])
    ...
    def OnShowPos(self, hwnd, msg, wparam, lparam):
        ...
        s = str(win32api.HIWORD(lparam) - win32api.HIWORD(wparam)) + ', '+str(win32api.LOWORD(lparam)-win32api.LOWORD(wparam))
